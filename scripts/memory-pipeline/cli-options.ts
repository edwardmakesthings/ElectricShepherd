 ...
 */
import type { SynthesisConsolidationOptions, TranscriptInsightSummary } from "../../adapter/synthesis-consolidation.ts";
import type { ValidationMergeReviewOptions } from "../../adapter/validation-merge-review.ts";
import type { CadenceArea, CadenceOrchestratorOptions } from "../../adapter/cadence-orchestrator.ts";
